...
namespace Mpdf;
// JMFA para Joomla:
\JLoader::registerNamespace('setasign\\Fpdi', JPATH_LIBRARIES.'/Mpdf/setasign/fpdi', false, false, 'psr4');    // JMFA: Complemento NECESARIO para la generación de PDF
\JLoader::registerNamespace('DeepCopy', JPATH_LIBRARIES.'/Mpdf/DeepCopy', false, false, 'psr4');                   // JMFA: Complemento NECESARIO para la generación de PDF (tablas de contenido)
\JLoader::registerNamespace('Mpdf\\PsrLogAwareTrait', JPATH_LIBRARIES.'/Mpdf/psr-log-aware-trait', false, false, 'psr4');
\JLoader::registerNamespace('Psr\\Http\\Message', JPATH_LIBRARIES.'/Mpdf/php-fig/http-message', false, false, 'psr4');
\JLoader::registerNamespace('Psr\\Log', JPATH_LIBRARIES.'/Mpdf/php-fig/log', false, false, 'psr4');
\JLoader::registerNamespace('Mpdf\\PsrHttpMessageShim', JPATH_LIBRARIES.'/Mpdf/psr-http-message-shim', false, false, 'psr4');
// Fin JMFA
